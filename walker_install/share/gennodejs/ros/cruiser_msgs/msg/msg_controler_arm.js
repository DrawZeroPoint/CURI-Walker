...
class msg_controler_arm {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type msg_controler_arm
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type msg_controler_arm
    let len;
    let data = new msg_controler_arm(null);
  ...
  static datatype() {
    ...
    return 'cruiser_msgs/msg_controler_arm';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new msg_controler_arm(null);
...
module.exports = msg_controler_arm;
