...
class cruiser_joint_motion {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cruiser_joint_motion
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cruiser_joint_motion
    let len;
    let data = new cruiser_joint_motion(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new cruiser_joint_motion(null);
...
module.exports = cruiser_joint_motion;
