...
class msg_controler_joint {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new msg_controler_joint(null);
  ...
  static datatype() {
    ...
    return 'cruiser_msgs/msg_controler_joint';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new msg_controler_joint(null);
...
module.exports = msg_controler_joint;
