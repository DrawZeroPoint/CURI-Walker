...
class cruiserCanCount {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cruiserCanCount
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cruiserCanCount
    let len;
    let data = new cruiserCanCount(null);
  ...
  static datatype() {
    ...
    return 'cruiser_msgs/cruiserCanCount';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cruiserCanCount(null);
...
module.exports = cruiserCanCount;
