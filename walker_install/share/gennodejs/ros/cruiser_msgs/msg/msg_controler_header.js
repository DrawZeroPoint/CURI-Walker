...
class msg_controler_header {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type msg_controler_header
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type msg_controler_header
    let len;
    let data = new msg_controler_header(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new msg_controler_header(null);
...
module.exports = msg_controler_header;
