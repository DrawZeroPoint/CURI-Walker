...
class cruiserSensorChargeIr {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint32(obj.data7, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new cruiserSensorChargeIr(null);
    ...
    data.data7 = _deserializer.uint32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new cruiserSensorChargeIr(null);
...
module.exports = cruiserSensorChargeIr;
