...
class cruiserLocomotionStatus {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new cruiserLocomotionStatus(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new cruiserLocomotionStatus(null);
...
module.exports = cruiserLocomotionStatus;
