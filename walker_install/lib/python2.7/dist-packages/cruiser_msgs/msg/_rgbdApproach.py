...
"""autogenerated by genpy from cruiser_msgs/rgbdApproach.msg. Do not edit."""
import sys
...
"""
  __slots__ = ['approachStatus','distance']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2i().pack(_x.approachStatus, _x.distance))
