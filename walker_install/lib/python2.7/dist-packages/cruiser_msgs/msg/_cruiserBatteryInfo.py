...
"""autogenerated by genpy from cruiser_msgs/cruiserBatteryInfo.msg. Do not edit."""
import sys
...
"""
  __slots__ = ['battery_level','voltage','charge_status','temperature']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       battery_level,voltage,charge_status,temperature
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4I().pack(_x.battery_level, _x.voltage, _x.charge_status, _x.temperature))
