...
"""autogenerated by genpy from cruiser_msgs/cruiser_common_status.msg. Do not edit."""
import sys
...
int32 value
int32 data"""
  __slots__ = ['status','value','data']
  _slot_types = ['byte','int32','int32']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_b2i().pack(_x.status, _x.value, _x.data))
