...
"""autogenerated by genpy from cruiser_msgs/GetVirtualPathRequest.msg. Do not edit."""
import sys
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetVirtualPathRequest, self).__init__(*args, **kwds)
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from cruiser_msgs/GetVirtualPathResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
"""
  __slots__ = ['path']
  _slot_types = ['cruiser_msgs/VirtualPath']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2If2I7d().pack(_x.path.info.map_load_time.secs, _x.path.info.map_load_time.nsecs, _x.path.info.resolution, _x.path.info.width, _x.path.info.height, _x.path.info.origin.position.x, _x.path.info.origin.position.y, _x.path.info.origin.position.z, _x.path.info.origin.orientation.x, _x.path.info.origin.orientation.y, _x.path.info.origin.orientation.z, _x.path.info.origin.orientation.w))
      length = len(self.path.paths)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.path.info.map_load_time.secs, _x.path.info.map_load_time.nsecs, _x.path.info.resolution, _x.path.info.width, _x.path.info.height, _x.path.info.origin.position.x, _x.path.info.origin.position.y, _x.path.info.origin.position.z, _x.path.info.origin.orientation.x, _x.path.info.origin.orientation.y, _x.path.info.origin.orientation.z, _x.path.info.origin.orientation.w,) = _get_struct_2If2I7d().unpack(str[start:end])
      start = end
      end += 4
...
class GetVirtualPath(object):
  ...
  _md5sum = 'efa773451ece228573f2fb4e72387f99'
  _request_class  = GetVirtualPathRequest
  _response_class = GetVirtualPathResponse
